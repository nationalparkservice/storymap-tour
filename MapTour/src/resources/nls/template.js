	...
	root: ({
		viewer: {
			...
			builderHTML: {
				...
				settingsLogoExplain: "Customize the header logo (maximum is 105 x 105px).",
				settingsLogoEsri: "NPS logo",
                ...
                settingsLogoSocialExplain: "Park Banner: Unit Code or Unit|Description|Location",
                settingsLogoSocialText: "Unit",
